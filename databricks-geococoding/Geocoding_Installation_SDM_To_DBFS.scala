...
val PB_API_KEY = "YOUR_PDX_API_KEY";
val PB_SECRET = "YOUR_PDX_SECRET_KEY";
...
// MAGIC printf '%s\n' "${GEOCODING_SPDS[@]}" | xargs -P 4 -I {spd} java -cp $SDM_CLASSPATH $SDM_CLASSNAME -a $PB_API_KEY -s $PB_SECRET -d $LOCAL_DATA_ZIPPED -dd \"{spd}\"
