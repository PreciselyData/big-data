...
A collection of samples demonstrating how to use Location Intelligence for Big Data.
...
<ol>
  <li><strong>Pyspark notebooks for Spark UDF</strong> https://github.com/PreciselyData/big-data/blob/release-5.2.3/pyspark/databricks-li/LI-SDK-UDF-Pyspark.ipynb</li>
  <li><strong>Pyspark notebooks for Spark drivers</strong> https://github.com/PreciselyData/big-data/blob/release-5.2.3/pyspark/databricks-li/LI-SDK-Drivers-Pyspark.ipynb</li>
  <li><strong>Scala notebooks for Spark UDF</strong> https://github.com/PreciselyData/big-data/blob/release-5.2.3/scala/databricks-li/Spark-sql-functions.scala</li>
  <li><strong>Scala notebooks for Spark drivers</strong> https://github.com/PreciselyData/big-data/tree/release-5.2.3/scala/databricks-li</li>
</ol>
